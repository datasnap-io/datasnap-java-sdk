...
public class DataSnap {
	...
	/**
	 * Creates a new Datasnap.io client- a HTTP wrapper over the Datasnap.io
	 * REST API. It is designed to be be thread-safe, using batching to
	 * efficiently send requests on a separate resource-constrained thread pool.
	 */
